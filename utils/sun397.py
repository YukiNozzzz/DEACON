...
def load_sun397(data_dir, input_size, partial_rate, batch_size):
    ...
    train_dataset = MySUN397(data_dir, download=True, data_tuple=None, partial_rate=partial_rate,
    ...
    test_loader = torch.utils.data.DataLoader(dataset=test_dataset, batch_size=batch_size*4, shuffle=False, num_workers=8)
